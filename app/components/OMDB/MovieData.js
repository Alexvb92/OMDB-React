    ...
    return (
      <div>
        ...
        <div className="textbox col-md-6" >
          ...
          {this.props.moviedata.Actors && <div className="well well-sm" style={centeralignmargin}> {this.props.moviedata.Director && <div style={centeralignmargin}>Directed by {this.props.moviedata.Director}</div>}<h2 >Starring:</h2> {this.props.moviedata.Actors}</div>}
          <div >
